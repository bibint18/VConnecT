    ...
    <main className="bg-black text-white">
      <section className="flex flex-col items-center justify-center h-screen text-center px-4">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">
          CONNECT THE PEOPLE THROUGH <br />V
          <span className="text-purple-500">CONNECT</span>
        </h1>
        {!isAuthenticated && (
          <button
            className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 py-2 rounded-full text-sm md:text-base hover:scale-105 transition-transform w-24"
      ...
      <section className="flex flex-col md:flex-row items-center justify-center py-16 px-4">
        ...
        <div className="w-full md:w-1/2 md:pl-8 text-center md:text-left">
          ...
          <p className="text-gray-400 mb-6">
            Host meetings, hang out with friends, or collaborate with your team
            — all in real-time, no downloads needed. Start your room. Share the
            code, Talk. It's that simple.
          </p>
      ...
      <section className="bg-black text-white py-16 px-4 flex flex-col md:flex-row items-center justify-center">
        <div className="w-full md:w-1/2 md:pr-8 text-left">
          ...
          <p className="text-gray-300 mb-8 max-w-lg">
            VConnect is a seamless solution for creating private virtual rooms
            and communicating in real time. Designed for professionals, teams,
            and communities, it allows you to connect effortlessly.
          </p>
          <button
            onClick={() => navigate("/addRoom")}
            className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-6 py-3 rounded-lg shadow-md hover:bg-gradient-to-r hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105"
          >
            Create Room
          </button>
        </div>
