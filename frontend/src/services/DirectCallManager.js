...
export class DirectCallManager {
    constructor(callId, userId, callDetails, streamCallback) {
        ...
        Object.defineProperty(this, "callDetails", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        }); // CHANGE: Added callDetails property
        Object.defineProperty(this, "streamCallback", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "isCallActive", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
